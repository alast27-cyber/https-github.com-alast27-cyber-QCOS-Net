...
const highlightQLang = (line: string) => {
    ...
    // Operators
    line = line.replace(/\b(OP::H|OP::X|OP::Y|OP::Z|OP::S|OP::T|OP::CNOT|OP::CNOT|OP::MEASURE|OP::RETURN_RESULT|OP::I|OP::CZ|OP::RZ|OP::RY)\b/g, '<span class="text-yellow-400">$1</span>');
