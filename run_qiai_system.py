...
if project_root not in sys.path:
    ...
    sys.path.insert(0, os.path.join(project_root, 'src', 'ai-core'))

# Now standard imports will work across the entire directory tree
from bridge.qiai_ips_bridge import QIAI_IPS_Bridge
from interface.qiai_chat_interface import QIAI_Terminal_Assistant
