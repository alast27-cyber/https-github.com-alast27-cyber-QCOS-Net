...
const DashboardContent: React.FC = () => {
  ...
  const [currentPage, setCurrentPage] = useState<'qcos' | 'chips' | 'gus' | 'backend'>('qcos');
  ...
  if (maximizedPanelId) {
      ...
      if (!foundPanel) {
          const directMap: any = {
             ...
             'quantum-execution-flow': { title: 'Execution Flow', content: <QuantumExecutionFlow /> },
             ...
             'backend-monitor': { title: 'Backend Infrastructure Monitor', content: <BackendMonitor /> },
