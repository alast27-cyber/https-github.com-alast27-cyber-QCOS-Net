                ...
                <div className="flex items-end gap-2 md:col-span-2">
                     {qmlEngine.status === 'IDLE' || qmlEngine.status === 'CONVERGED' || qmlEngine.status === 'FAILED' ? (
                        <>
                         ...
                         <button onClick={stopQMLTraining} className="w-full holographic-button py-2 text-xs font-bold bg-red-600/20 border-red-500 text-red-300 flex items-center justify-center gap-2 hover:bg-red-600/40">
            ...
            <div className="flex-grow flex gap-4 min-h-0 relative">
                ...
                {showLibrary && (
                    <div className="w-1/3 bg-black/30 rounded-lg border border-cyan-900/50 flex flex-col overflow-hidden animate-fade-in-right">
                         <div className="p-2 border-b border-cyan-900/50 bg-cyan-950/20 text-xs font-bold text-cyan-300 flex items-center justify-between">
