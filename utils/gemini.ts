...
// Enhanced check for retriable errors including server errors (5xx)
            ...
            if (isRetriableError(e) && i < retries - 1) {
                ...
                if (e instanceof Error) {
                    ...
                    if (msg.includes('failed to fetch') || msg.includes('network error')) {
                        throw new Error('System Alert: Network connection lost. Please check your internet connection.');
                    }
