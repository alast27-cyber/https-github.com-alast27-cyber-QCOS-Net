...
const SUGGESTIONS_MAP: Record<string, string[]> = {
    'agentq-core': ['Optimize Local Node', 'Expand Context Window', 'Diverge Timelines'],
    'chimera-browser': ['Resolve Q-URI', 'Analyze Tab Content', 'Check EKS Link'],
    'universe-simulator': ['Run Timeline Analysis', 'Inject Preset', 'Predict Best Preset'],
    'chips-dev-platform': ['Architect new React App', 'Generate Q-Lang Protocol', 'Refactor current file', 'Optimize for QPU'],
    'cqdp-coding': ['Generate data_processing.py', 'Refactor main.rs', 'Optimize App.tsx', 'Debug quantum_circuit.q'],
    'chips-economy': ['Run Risk Simulation', 'Check CYC Price', 'Verify Ledger Integrity']
};
...
export const useAgentQ = ({ focusedPanelId, panelInfoMap, qcosVersion, systemHealth, onDashboardControl, fileSystemOps, projectOps }: UseAgentQProps) => {
    ...
    const suggestedActions = useMemo(() => {
        ...
        if (focusedPanelId.includes('cqdp') || focusedPanelId.includes('coding')) {
